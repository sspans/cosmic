...
@APICommand(name = "linkDomainToLdap", group = "Authentication", description = "link an existing cloudstack domain to group or OU in ldap", responseObject = LinkDomainToLdapResponse.class, since = "4.6.0",
