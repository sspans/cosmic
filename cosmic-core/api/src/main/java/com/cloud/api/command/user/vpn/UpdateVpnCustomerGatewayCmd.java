...
@APICommand(name = "updateVpnCustomerGateway", group = "VPN", description = "Update site to site vpn customer gateway", responseObject = Site2SiteCustomerGatewayResponse.class, entityType =
