...
@APICommand(name = "releasePublicIpRange", group = "Network", description = "Releases a Public IP range back to the system pool", responseObject = SuccessResponse.class,
