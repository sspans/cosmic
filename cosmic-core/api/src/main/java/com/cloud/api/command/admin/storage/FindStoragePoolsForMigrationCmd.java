...
@APICommand(name = "findStoragePoolsForMigration", group = "Storage Pool", description = "Lists storage pools available for migration of a volume.", responseObject = StoragePoolResponse.class,
