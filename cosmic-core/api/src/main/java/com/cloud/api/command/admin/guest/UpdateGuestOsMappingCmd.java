...
@APICommand(name = "updateGuestOsMapping", group = "Guest OS", description = "Updates the information about Guest OS to Hypervisor specific name mapping", responseObject = GuestOsMappingResponse
        .class,
