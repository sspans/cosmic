...
@APICommand(name = "expungeVirtualMachine", group = "Virtual Machine", description = "Expunge a virtual machine. Once expunged, it cannot be recoverd.", responseObject = SuccessResponse.class, entityType
