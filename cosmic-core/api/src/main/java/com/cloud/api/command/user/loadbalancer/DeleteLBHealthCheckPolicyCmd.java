...
@APICommand(name = "deleteLBHealthCheckPolicy", group = "Load Balancer", description = "Deletes a load balancer health check policy.", responseObject = SuccessResponse.class, since = "4.2.0",
