...
@APICommand(name = "updateProjectInvitation", group = "Project", description = "Accepts or declines project invitation", responseObject = SuccessResponse.class, since = "3.0.0",
