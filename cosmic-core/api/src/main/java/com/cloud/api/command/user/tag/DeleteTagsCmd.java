...
@APICommand(name = "deleteTags", group = "Resource tags", description = "Deleting resource tag(s)", responseObject = SuccessResponse.class, since = "4.0.0", entityType = {ResourceTag.class},
