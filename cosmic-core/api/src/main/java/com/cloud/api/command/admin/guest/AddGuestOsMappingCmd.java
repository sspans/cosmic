...
@APICommand(name = "addGuestOsMapping", group = "Guest OS", description = "Adds a guest OS name to hypervisor OS name mapping", responseObject = GuestOsMappingResponse.class,
