...
@APICommand(name = "listDeploymentPlanners", group = "Configuration", description = "Lists all DeploymentPlanners available.", responseObject = DeploymentPlannersResponse.class,
