...
@APICommand(name = "createPrivateGateway", group = "VPC", description = "Creates a private gateway", responseObject = PrivateGatewayResponse.class, entityType = {VpcGateway.class},
