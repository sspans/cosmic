...
@APICommand(name = "deleteVpnConnection", group = "VPN", description = "Delete site to site vpn connection", responseObject = SuccessResponse.class, entityType = {Site2SiteVpnConnection.class},
