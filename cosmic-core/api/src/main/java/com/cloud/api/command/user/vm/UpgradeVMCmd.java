...
@APICommand(name = "changeServiceForVirtualMachine", group = "Virtual Machine", responseObject = UserVmResponse.class, description = "Changes the service offering for a virtual machine. " +
