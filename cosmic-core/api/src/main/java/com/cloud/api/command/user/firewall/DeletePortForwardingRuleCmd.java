...
@APICommand(name = "deletePortForwardingRule", group = "Firewall", description = "Deletes a port forwarding rule", responseObject = SuccessResponse.class, entityType = {PortForwardingRule.class},
