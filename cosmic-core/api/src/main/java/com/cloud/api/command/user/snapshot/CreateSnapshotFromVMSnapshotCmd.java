...
@APICommand(name = "createSnapshotFromVMSnapshot", group = "Snapshot", description = "Creates an instant snapshot of a volume from existing vm snapshot.", responseObject = SnapshotResponse.class,
