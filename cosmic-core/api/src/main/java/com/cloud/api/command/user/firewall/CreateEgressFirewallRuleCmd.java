...
@APICommand(name = "createEgressFirewallRule", group = "Firewall", description = "Creates a egress firewall rule for a given network ", responseObject = FirewallResponse.class, entityType =
        {FirewallRule.class},
