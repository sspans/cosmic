...
@APICommand(name = "changeServiceForSystemVm", group = "System VM", responseObject = SystemVmResponse.class, description = "Changes the service offering for a system vm (console proxy or secondary " +
        "storage). "
