...
@APICommand(name = "destroyVirtualMachine", group = "Virtual Machine", description = "Destroys a virtual machine.", responseObject = UserVmResponse.class, responseView = ResponseView.Restricted,
