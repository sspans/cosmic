...
@APICommand(name = "deleteFirewallRule", group = "Firewall", description = "Deletes a firewall rule", responseObject = SuccessResponse.class, entityType = {FirewallRule.class},
