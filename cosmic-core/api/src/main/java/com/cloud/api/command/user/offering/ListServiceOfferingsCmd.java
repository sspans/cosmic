...
@APICommand(name = "listServiceOfferings", group = "Service Offering", description = "Lists all available service offerings.", responseObject = ServiceOfferingResponse.class,
