...
@APICommand(name = BaseCmdTest.CMD1_NAME, group = "BaseCmdTest", responseObject = BaseResponse.class)
...
@APICommand(name = BaseCmdTest.CMD2_NAME, group = "BaseCmdTest", responseObject = BaseResponse.class)
